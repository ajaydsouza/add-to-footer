	    ...
	    <div id="genopdiv" class="postbox"><div class="handlediv" title="<?php _e( 'Click to toggle', 'add-to-footer' ); ?>"><br /></div>
          ...
          <div class="inside">
            <table class="form-table">
				<tr><th scope="row" style="background:#<?php if ( $addfoot_settings['enable_plugin'] ) { echo 'cfc';
} else { echo 'fcc'; } ?>"><label for="enable_plugin">&nbsp;<?php _e( 'Enable the plugin:', 'add-to-footer' ); ?></label></th>
					<td style="background:#<?php if ( $addfoot_settings['enable_plugin'] ) { echo 'cfc';
} else { echo 'fcc'; } ?>"><input type="checkbox" name="enable_plugin" id="enable_plugin" <?php if ( $addfoot_settings['enable_plugin'] ) { echo 'checked="checked"'; } ?> /></td>
                </tr>
                <tr>
